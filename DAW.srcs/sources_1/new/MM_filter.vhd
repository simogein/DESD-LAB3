...
architecture Behavioral of MM_filter is 

--------------------------CONSTANT DECLARATION-------------------------------
    --We need to declare two different constants cause shif_reg0 and sum are of different "dimensions"
    constant init_mm : std_logic_vector(WORD_BIT-1 downto 0) := std_logic_vector(to_signed(INIT,Data_in'LENGTH));
...
---------------------------SIGNAL DECLARATION--------------------------------
    signal shift_reg0 : shiftreg := (others => init_mm);
