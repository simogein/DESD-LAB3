...
-- Date        : Wed May 19 18:47:06 2021
-- Host        : DESKTOP-6KTOIJJ running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/SimoGein/Desktop/DESD/VHDL_Project_Local/LAB3/project_3/project_3.gen/sources_1/bd/design_1/ip/design_1_AXI4Stream_UART_0_0/design_1_AXI4Stream_UART_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_AXI4Stream_UART_0_0_UART_Engine is
  ...
  signal rx_baud_counter : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \rx_baud_counter[0]_i_1_n_0\ : STD_LOGIC;
  signal \rx_baud_counter[1]_i_1_n_0\ : STD_LOGIC;
  signal rx_baud_tick : STD_LOGIC;
  signal rx_baud_tick_i_1_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_uart_rx_state[1]_i_2\ : label is "soft_lutpair55";
  attribute SOFT_HLUTNM of \FSM_onehot_uart_rx_state[1]_i_3\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \FSM_onehot_uart_rx_state[2]_i_2\ : label is "soft_lutpair55";
  attribute SOFT_HLUTNM of \FSM_onehot_uart_rx_state[2]_i_3\ : label is "soft_lutpair56";
  ...
  attribute SOFT_HLUTNM of \rx_baud_counter[0]_i_1\ : label is "soft_lutpair57";
  attribute SOFT_HLUTNM of \rx_baud_counter[1]_i_1\ : label is "soft_lutpair57";
  ...
  attribute SOFT_HLUTNM of \tx_baud_counter[2]_i_1\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \tx_baud_counter[3]_i_1\ : label is "soft_lutpair49";
  ...
  attribute SOFT_HLUTNM of \uart_rx_count[1]_i_1\ : label is "soft_lutpair56";
  ...
  attribute SOFT_HLUTNM of uart_rx_data_in_done_i_1 : label is "soft_lutpair54";
  ...
  attribute SOFT_HLUTNM of \uart_rx_filter[0]_i_1\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \uart_rx_filter[1]_i_1\ : label is "soft_lutpair48";
  ...
  attribute SOFT_HLUTNM of uart_tx_data_i_2 : label is "soft_lutpair54";
...
\rx_baud_counter[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => rx_baud_counter(1),
...
\rx_baud_counter_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk_uart,
      CE => '1',
      D => \rx_baud_counter[1]_i_1_n_0\,
      Q => rx_baud_counter(1),
      R => rst
    );
rx_baud_tick_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
entity design_1_AXI4Stream_UART_0_0_AXI4Stream_UART_v1_0 is
  ...
  attribute UART_BAUD_RATE of design_1_AXI4Stream_UART_0_0_AXI4Stream_UART_v1_0 : entity is 2000000;
  attribute UART_CLOCK_FREQUENCY : integer;
  attribute UART_CLOCK_FREQUENCY of design_1_AXI4Stream_UART_0_0_AXI4Stream_UART_v1_0 : entity is 95833333;
