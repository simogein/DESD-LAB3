...
# module references:
# debouncer, debouncer, depacketizer, edge_detector, edge_detector, mobile_mean_filter, mute_controller, packetizer, volume_controller
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {137.895} \
   CONFIG.CLKOUT1_PHASE_ERROR {107.948} \
   CONFIG.CLKOUT2_JITTER {139.122} \
   CONFIG.CLKOUT2_PHASE_ERROR {107.948} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {96.000} \
   CONFIG.CLKOUT2_USED {true} \
   CONFIG.CLK_IN1_BOARD_INTERFACE {sys_clock} \
   CONFIG.CLK_OUT1_PORT {sys_clk} \
   CONFIG.CLK_OUT2_PORT {uart_clk} \
  ...
  # Create instance: mobile_mean_filter_0, and set properties
  set block_name mobile_mean_filter
  set block_cell_name mobile_mean_filter_0
  if { [catch {set mobile_mean_filter_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mobile_mean_filter_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net AXI4Stream_UART_0_M00_AXIS_RX [get_bd_intf_pins AXI4Stream_UART_0/M00_AXIS_RX] [get_bd_intf_pins depacketizer_0/s05_axis]
  connect_bd_intf_net -intf_net AXI4Stream_UART_0_UART [get_bd_intf_ports usb_uart] [get_bd_intf_pins AXI4Stream_UART_0/UART]
  connect_bd_intf_net -intf_net depacketizer_0_m05_axis [get_bd_intf_pins depacketizer_0/m05_axis] [get_bd_intf_pins mobile_mean_filter_0/s03_axis]
  connect_bd_intf_net -intf_net mobile_mean_filter_0_m03_axis [get_bd_intf_pins mobile_mean_filter_0/m03_axis] [get_bd_intf_pins volume_controller_0/s02_axis]
  connect_bd_intf_net -intf_net mute_controller_0_m_axis [get_bd_intf_pins mute_controller_0/m01_axis] [get_bd_intf_pins packetizer_0/s04_axis]
  connect_bd_intf_net -intf_net packetizer_0_m_axis [get_bd_intf_pins AXI4Stream_UART_0/S00_AXIS_TX] [get_bd_intf_pins packetizer_0/m04_axis]
  connect_bd_intf_net -intf_net volume_controller_0_m02_axis [get_bd_intf_pins mute_controller_0/s01_axis] [get_bd_intf_pins volume_controller_0/m02_axis]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins AXI4Stream_UART_0/m00_axis_rx_aresetn] [get_bd_pins AXI4Stream_UART_0/s00_axis_tx_aresetn] [get_bd_pins depacketizer_0/aresetn] [get_bd_pins mobile_mean_filter_0/aresetn] [get_bd_pins mute_controller_0/aresetn] [get_bd_pins packetizer_0/aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins volume_controller_0/aresetn]
  ...
  connect_bd_net -net clk_wiz_0_sys_clk [get_bd_pins AXI4Stream_UART_0/m00_axis_rx_aclk] [get_bd_pins AXI4Stream_UART_0/s00_axis_tx_aclk] [get_bd_pins clk_wiz_0/sys_clk] [get_bd_pins debouncer_0/clk] [get_bd_pins debouncer_1/clk] [get_bd_pins depacketizer_0/aclk] [get_bd_pins edge_detector_0/clk] [get_bd_pins edge_detector_1/clk] [get_bd_pins mobile_mean_filter_0/aclk] [get_bd_pins mute_controller_0/aclk] [get_bd_pins packetizer_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins volume_controller_0/aclk]
  connect_bd_net -net clk_wiz_0_uart_clk [get_bd_pins AXI4Stream_UART_0/clk_uart] [get_bd_pins clk_wiz_0/uart_clk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk]
  ...
  connect_bd_net -net edge_detector_0_edge_detected [get_bd_pins edge_detector_0/edge_detected] [get_bd_pins volume_controller_0/volume_down]
  connect_bd_net -net edge_detector_1_edge_detected [get_bd_pins edge_detector_1/edge_detected] [get_bd_pins volume_controller_0/volume_up]
  connect_bd_net -net enable_filter_0_1 [get_bd_ports sw0] [get_bd_pins mobile_mean_filter_0/enable_filter]
  connect_bd_net -net input_signal_0_1 [get_bd_ports btnD] [get_bd_pins debouncer_0/input_signal]
  connect_bd_net -net input_signal_0_2 [get_bd_ports btnU] [get_bd_pins debouncer_1/input_signal]
  connect_bd_net -net mute_left_0_1 [get_bd_ports btnR] [get_bd_pins mute_controller_0/mute_left]
  connect_bd_net -net mute_right_0_1 [get_bd_ports btnL] [get_bd_pins mute_controller_0/mute_right]
