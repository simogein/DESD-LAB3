...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Engine is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_uart_rx_state[1]_i_2\ : label is "soft_lutpair58";
  attribute SOFT_HLUTNM of \FSM_onehot_uart_rx_state[1]_i_3\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \FSM_onehot_uart_rx_state[2]_i_2\ : label is "soft_lutpair58";
  attribute SOFT_HLUTNM of \FSM_onehot_uart_rx_state[2]_i_3\ : label is "soft_lutpair59";
  ...
  attribute SOFT_HLUTNM of \rx_baud_counter[1]_i_1\ : label is "soft_lutpair52";
  attribute SOFT_HLUTNM of \rx_baud_counter[3]_i_1\ : label is "soft_lutpair52";
  attribute SOFT_HLUTNM of \tx_baud_counter[1]_i_1\ : label is "soft_lutpair60";
  attribute SOFT_HLUTNM of \tx_baud_counter[2]_i_1\ : label is "soft_lutpair60";
  attribute SOFT_HLUTNM of \tx_baud_counter[3]_i_1\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \tx_baud_counter[4]_i_1\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \tx_baud_counter[6]_i_1\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \tx_baud_counter[8]_i_1\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \tx_baud_counter[9]_i_1\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of tx_baud_tick_i_1 : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \uart_rx_bit_spacing[0]_i_1\ : label is "soft_lutpair55";
  attribute SOFT_HLUTNM of \uart_rx_bit_spacing[1]_i_1\ : label is "soft_lutpair55";
  ...
  attribute SOFT_HLUTNM of \uart_rx_count[1]_i_1\ : label is "soft_lutpair59";
  ...
  attribute SOFT_HLUTNM of uart_rx_data_in_done_i_1 : label is "soft_lutpair57";
  attribute SOFT_HLUTNM of \uart_rx_data_sr[0]_i_1\ : label is "soft_lutpair56";
  attribute SOFT_HLUTNM of \uart_rx_data_sr[1]_i_1\ : label is "soft_lutpair56";
  attribute SOFT_HLUTNM of \uart_rx_filter[0]_i_1\ : label is "soft_lutpair51";
  attribute SOFT_HLUTNM of \uart_rx_filter[1]_i_1\ : label is "soft_lutpair51";
  attribute SOFT_HLUTNM of \uart_tx_count[0]_i_1\ : label is "soft_lutpair54";
  attribute SOFT_HLUTNM of \uart_tx_count[1]_i_1\ : label is "soft_lutpair53";
  attribute SOFT_HLUTNM of \uart_tx_count[2]_i_2\ : label is "soft_lutpair53";
  attribute SOFT_HLUTNM of uart_tx_data_i_2 : label is "soft_lutpair57";
  attribute KEEP : string;
  attribute KEEP of uart_tx_data_reg : label is "yes";
  attribute SOFT_HLUTNM of \uart_tx_data_vec[0]_i_1\ : label is "soft_lutpair54";
...
\rx_baud_counter[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
      I0 => rx_baud_counter(0),
      I1 => rx_baud_counter(1),
      O => rx_baud_counter_0(1)
    );
\rx_baud_counter[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7870787878787878"
    )
        port map (
      I0 => rx_baud_counter(0),
      I1 => rx_baud_counter(1),
      I2 => rx_baud_counter(2),
...
\tx_baud_counter[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => tx_baud_counter(8),
      I2 => tx_baud_counter(7),
      I3 => tx_baud_counter(9),
      I4 => tx_baud_counter(6),
      O => tx_baud_counter_1(6)
    );
\tx_baud_counter[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D2"
    )
        port map (
      I0 => tx_baud_counter(6),
...
\tx_baud_counter[8]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I3 => tx_baud_counter(9),
      I4 => tx_baud_counter(7),
      O => tx_baud_counter_1(8)
    );
\tx_baud_counter[9]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BFEF4000"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_Manager is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \data_stream_in[0]_i_1\ : label is "soft_lutpair61";
  attribute SOFT_HLUTNM of \data_stream_in[1]_i_1\ : label is "soft_lutpair61";
  attribute SOFT_HLUTNM of \data_stream_in[2]_i_1\ : label is "soft_lutpair62";
  attribute SOFT_HLUTNM of \data_stream_in[3]_i_1\ : label is "soft_lutpair62";
  attribute SOFT_HLUTNM of \data_stream_in[4]_i_1\ : label is "soft_lutpair63";
  attribute SOFT_HLUTNM of \data_stream_in[5]_i_1\ : label is "soft_lutpair63";
  attribute SOFT_HLUTNM of \data_stream_in[6]_i_1\ : label is "soft_lutpair64";
  attribute SOFT_HLUTNM of \data_stream_in[7]_i_2\ : label is "soft_lutpair64";
begin
  rd_en <= \^rd_en\;
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI4Stream_UART_v1_0 is
  ...
  attribute UART_CLOCK_FREQUENCY of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI4Stream_UART_v1_0 : entity is 95833333;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI4Stream_UART_v1_0 is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of FIFO_DATA_RX_i_1 : label is "soft_lutpair66";
  ...
  attribute SOFT_HLUTNM of FIFO_DATA_TX_i_2 : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of m00_axis_rx_tvalid_INST_0 : label is "soft_lutpair66";
  attribute SOFT_HLUTNM of s00_axis_tx_tready_INST_0 : label is "soft_lutpair65";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute UART_CLOCK_FREQUENCY : integer;
  attribute UART_CLOCK_FREQUENCY of U0 : label is 95833333;
  ...
  attribute x_interface_parameter of clk_uart : signal is "XIL_INTERFACENAME ClockUART, ASSOCIATED_BUSIF UART, ASSOCIATED_RESET rst, FREQ_HZ 95833333, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0";
