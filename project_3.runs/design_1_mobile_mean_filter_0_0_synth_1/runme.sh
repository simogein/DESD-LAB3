...
EAStep vivado -log design_1_mobile_mean_filter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mobile_mean_filter_0_0.tcl
