...
HD_PWD='D:/Documenti/LEZIONI/Digital Electronic System Design/Project/DAW/DAW.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_DAW_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bd_DAW_wrapper.tcl -notrace
