...
HD_PWD='D:/Documenti/LEZIONI/Digital Electronic System Design/Project/DAW/DAW.runs/bd_DAW_AXI4_S_interface_FSM_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_DAW_AXI4_S_interface_FSM_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_DAW_AXI4_S_interface_FSM_0_0.tcl
