...
HD_PWD='D:/Documenti/LEZIONI/Digital Electronic System Design/Project/DAW/DAW.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_DAW_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_DAW_wrapper.tcl
